...
function GetJS()
{
	...
	var _0x1ac514 = $(location).attr('hostname') + "/" + confurl[_0x3a35e3];
	var _0x1eeab7 = {
	...
	cordovaHTTP['acceptAllCerts'](!![], function ()
	{
		...
		{}, _0x1eeab7, function (_0x40568f)
		{
			...
			else
			{
				setTimeout(function ()
				{
					if (confurl['length'] == 0x1) alert(_0x1ac514 + ' woy Jel Aplikasi Mengalami Kesalahan Pengambilan Data, Harap Laporkan Lewat Sosial Media INDOXXI / Chatango!');
					else
					{
